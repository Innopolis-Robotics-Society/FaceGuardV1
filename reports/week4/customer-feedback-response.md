...
| CFR-007 | Technical Risk | Link-check failures appeared on product PRs and latest `main`. | Keep Lychee separate from additional QA, fix broken links before final submission, and do not claim protected-main CI success until rechecked. | Selected Sprint scope | PR #50, PR #51, PR #52 | In Progress | GitHub Actions evidence from June 28, 2026. |
