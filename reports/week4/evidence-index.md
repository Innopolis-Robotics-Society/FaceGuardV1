...
access, or instructor-only notes.

| Requirement | Public evidence | Private evidence | Status | Remaining action |
| --- | --- | --- | --- | --- |
| Backlog | [Product Backlog view](https://github.com/orgs/Innopolis-Robotics-Society/projects/7/views/1) | Not required | In Progress | Confirm final Project view before submission. |
| Sprint milestone | [Sprint 2 - Increment](https://github.com/Innopolis-Robotics-Society/FaceGuardV1/milestone/2) | Not required | In Progress | Close selected issues through merged PRs. |
| Sprint Goal | Milestone description and [roadmap](../../docs/roadmap.md) | Not required | Delivered | Recheck after final scope changes. |
...
| PR links | [#49](https://github.com/Innopolis-Robotics-Society/FaceGuardV1/pull/49), [#50](https://github.com/Innopolis-Robotics-Society/FaceGuardV1/pull/50), [#51](https://github.com/Innopolis-Robotics-Society/FaceGuardV1/pull/51), [#52](https://github.com/Innopolis-Robotics-Society/FaceGuardV1/pull/52) | Not required | Delivered | Selected PRs are merged; this documentation PR remains pending. |
| Review evidence | PR #49, #50, #51, and #52 review records | Not required | Delivered | Preserve final documentation PR review evidence. |
| CI | [PR #49 Quality gates run](https://github.com/Innopolis-Robotics-Society/FaceGuardV1/actions/runs/28290665283) | Not required | Delivered for PR #49 | Rerun after this documentation PR and preserve final `main` evidence. |
| QRT | PR #49 `Quality requirement tests` job | Not required | Delivered for PR #49 | Preserve final run link after documentation PR. |
| Coverage | PR #49 coverage values and `backend-coverage` artifact | Not required | Delivered for PR #49 | Attach final coverage evidence after latest CI run. |
| Additional QA | Docker Compose validation job in PR #49 | Not required | Delivered for PR #49 | Preserve final job link after latest CI run. |
| Link checking | Lychee workflow | Not required | In Progress | Fix failing links on latest `main` and product PRs. |
