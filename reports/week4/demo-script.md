...
| 0:35-0:55 | Access Logs | Access Logs page with timestamp, result, person/Unknown, device/location, filters, and pagination if merged. | If PR #50 is not merged, mark as pending and do not demo as delivered. |
| 0:55-1:15 | Edit person | Open a test person and update safe test fields if merged. | If PR #51 is not merged, mark as pending. |
