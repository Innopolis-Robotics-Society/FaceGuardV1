...
These items are not released until merged to `main`.
...
- [#48](https://github.com/Innopolis-Robotics-Society/FaceGuardV1/issues/48)
  ...
  quality gates and Week 4 documentation.
...
- Final `main` quality workflow: Pending Merge.
- Latest `main` link-check run: failure after PR #52; must be fixed before
  release.
...
- Assignment 4 product PRs #50 and #51 are still open.
...
- [ ] Merge PR #49.
- [ ] Merge PR #50 after checks are green.
- [ ] Merge PR #51 after review, cleanup, and green checks.
