...
FaceGuard is an MVP access-control system with an administrator web
application, a FastAPI backend, PostgreSQL persistence, and an edge recognition
agent connected to local camera hardware.
...
- [Week 2 report](https://github.com/Innopolis-Robotics-Society/FaceGuardV1/blob/main/reports/week2/README.md)
